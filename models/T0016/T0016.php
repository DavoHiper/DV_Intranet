...
//        echo $sql;
    ...
    public function selecionaTipoArquivo()
    {
        return $this->query("SELECT T.T056_codigo   AS COD
                               ...
                               WHERE T.T056_codigo NOT IN (19,2,3,13,14,17,18,20,21,22,23,24,25,26,27,29)");
    }
    ...
    public function listaWF()
    {
       return $this->query("SELECT T59.T059_codigo	COD
                             ...
                             WHERE T60.T060_ordem = 3
                               AND T60.T061_codigo = 1
                             ORDER BY 1");
    }
    ...
    {
        $sql    =   "      SELECT T2659.T059_codigo COD
                                , T59.T059_nome NOM
                             FROM T026_T059 T2659 
                             JOIN T026_fornecedor T26 ON T26.T026_codigo = T2659.T026_codigo 
                             JOIN T059_grupo_workflow T59 ON T2659.T059_codigo = T59.T059_codigo
                            WHERE T2659.T026_codigo  = $cod
                              AND T2659.T006_codigo = $loja";
   ...
   public function selecionaAPDF($cod)
   {
       return $this->query("   SELECT A.T008_codigo                P0016_T008_COD
                                    ...
                                    , T120.T120_codigo             CodigoCategoria
                                ...
                                INNER JOIN T059_grupo_workflow as E
                                 ...
                                 LEFT JOIN T120_fornecedor_categoria T120
                                   ON A.T026_codigo = T120.T026_codigo
                                  AND A.T120_codigo = T120.T120_codigo
...
//        echo $sql;
    ...
    public function retornaApsForaControladoria()
    {
        $sql    =   "  SELECT T08.T008_codigo  CodigoAp
                            , T08.T004_login   Login
                         FROM T008_approval T08
                        WHERE T08.T004_login NOT IN ('tparrei','msasanto','lbsilva')
                          AND T08.T008_dt_elaboracao = sysdate();";
