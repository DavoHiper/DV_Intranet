...
//        echo $sql;
    ...
    public function retornaDespesasPagas($user, $FiltroQuery, $FiltroRegistros)
    {
        $sql    =   "  SELECT T16.T016_codigo                                   DespesaCodigo
                            , T16.T004_login                                    Login
                            , date_format(T16.T016_dt_elaboracao,'%d/%m/%Y')    DespesaData
                            , T60.T060_codigo                                   CodigoEtapa
                            , T16.T016_vl_total_geral                           DespesaValor
                            , T60.T059_codigo                                   CodigoGrupo
                         FROM (
                               SELECT T16.T016_codigo
                                 FROM T016_T060 T1660
                                 JOIN T016_despesa T16 ON T16.T016_codigo = T1660.T016_codigo
                                 JOIN T060_workflow T60 ON T1660.T060_codigo = T60.T060_codigo
                                 JOIN T059_grupo_workflow T59 ON T60.T059_codigo = T59.T059_codigo
                                 JOIN T004_T059 T0459 ON T59.T059_codigo = T0459.T059_codigo
                                WHERE T0459.T004_login = '$user'
                                  AND T16.T016_status  = 9
                               )SE
                         JOIN T016_T060 T1660 ON SE.T016_codigo = T1660.T016_codigo
                         JOIN T016_despesa T16 ON SE.T016_codigo = T16.T016_codigo
                         JOIN T060_workflow T60 ON T60.T060_codigo = T1660.T060_codigo
                        WHERE T60.T059_codigo  = 253
                          AND T1660.T016_T060_status = 1";
    ...
    public function retornaDespesasNaoPagas($user, $FiltroQuery, $FiltroRegistros)
    {
        $sql    =   "  SELECT T16.T016_codigo                                   DespesaCodigo
                            , T16.T004_login                                    Login
                            , date_format(T16.T016_dt_elaboracao,'%d/%m/%Y')    DespesaData
    ...
    public function retornaDespesasPosteriores($user, $FiltroQuery, $FiltroRegistros)
    {
        $sql    =   " SELECT DISTINCT T16.T016_codigo                                   AS DespesaCodigo
                                    ...
                                    FROM (  SELECT T1660.T016_codigo DESPESA , max(T1660.T016_T060_ordem) ordem
                                            ...
                                            JOIN T060_workflow T60    ON ( T60.T059_codigo  =  T0459.T059_codigo )
                                            WHERE T1660.T060_codigo  = T60.T060_codigo
                                            AND T1660.T016_T060_dt_aprovacao IS NOT NULL 
                                            GROUP BY T1660.T016_codigo
                                        ) SE2
                                    JOIN T016_T060 T1660_2 ON (     T1660_2.T016_codigo     = SE2.DESPESA
                                                                AND T1660_2.T016_T060_ordem > SE2.ordem
...
//        echo $sql;
    ...
    public function retornaDespesa($DespesaCodigo)
    {
        $sql    =   "  SELECT T16.T016_codigo                                   DespesaCodigo
                           ...
                           FROM    T016_despesa T16
                                JOIN
                                   T004_usuario T04
                                   ON T16.T004_login = T04.T004_login
                        WHERE T16.T016_codigo  = $DespesaCodigo";
    ...
    public function retornaDespesaDetalhe($DespesaCodigo)
    {
        $sql    =   "  SELECT date_format(T1516.T015_T016_saida,'%d/%m/%Y %H:%i')   DespesaSaida
                            , date_format(T1516.T015_T016_saida,'%d/%m/%Y')         DespesaDtSaida
                            ...
                            , T1516.T015_T016_seq                                   SeqDespesa
                     ...
                     ORDER BY date_format(T1516.T015_T016_saida,'%d/%m/%Y %H:%i')         asc"
                           ;
    ...
    public function retornaUltimaEtapaDespesa($DespesaCodigo)
    {
        $sql    =   " SELECT T060_codigo UltimaEtapa 
                        FROM
                            (
                                SELECT T016_T060.T016_codigo cod ,  max(T016_T060_ordem) ordem
                                FROM T016_T060
    ...
    public function retornaDetDespesa($codigoDespesa, $codigoSequencia){
        $sql    =   "";
