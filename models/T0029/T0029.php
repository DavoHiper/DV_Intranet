...
class models_T0029 extends models
{
    ...
    public function verificaPublico($codigo) {
        
        $sql = "SELECT T055_publico Publico
                  FROM  T055_arquivos
...
//                          ORDER BY 1 DESC");
    ...
    public function retornaDepartamentoUser($user) {
        
        $sql    =   "SELECT     T040677.T004_login     Usuario
                               ,T040677.T077_codigo    Departamento
                        FROM    T004_T006_T077  T040677
                       WHERE    T040677.T004_login  =   '".$user."' AND T077_codigo = 44";
