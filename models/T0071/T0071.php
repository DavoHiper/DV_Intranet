...
class models_T0071 extends models
{
    ...
    // Usa o código do fornecedor para retornar aps
    public function retornaNotasFornecedorCategoria($codigo,$data_inicial,$data_final,$categoria)
    {
        $sql = "SELECT TF1.T026_codigo                                  Codigo
                     , TF1.T026_rms_razao_social                        RazaoSocial
                     , TJ1.T008_codigo                                  Ap
                 ...
                 WHERE TF1.T026_codigo                  =  $codigo
                   ...
                   AND TJ1.T008_nf_dt_emiss             <= '$data_final'";
                if($categoria=='')                                              
                   $sql .= " AND TJ1.T120_codigo                  IS NULL";   
                else
                   $sql .= " AND TJ1.T120_codigo                  =  $categoria";
                
              $sql .=   " ORDER BY TJ1.T008_nf_dt_emiss";
    ...
    public function retornaCategorias()
    {
        $sql = "   SELECT T120.T120_codigo   CodigoCategoria
                    ...
                    SELECT ''   CodigoCategoria
                         , 'SEM CATEGORIA'     NomeCategoria
                         , 'SEM CATEGORIA'     DescricaoCategoria     
                      FROM DUAL";
