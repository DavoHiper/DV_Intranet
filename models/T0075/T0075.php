     ...
     public function  retornaBuscaComboLoja($lojaPost)
    {
        switch($lojaPost){
            ...
            case "013":
                ...
                break;
            case "019":
                $busca = "<option value='019'>".$lojaPost." - DAVO POSTO GUAIANASES</option>";
                break;
            case "020":
                $busca = "<option value='020'>".$lojaPost." - DAVO FARMA ITAIM</option>";
                break;
            case "021":
                $busca = "<option value='021'>".$lojaPost." - DAVO ITAQUAQUECETUBA</option>";
                break;
        }
