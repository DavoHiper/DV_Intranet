...
//                }
    ...
    public function retornaTelefones($user)
    {
        $sql    =   "  SELECT T10.T010_id       Id
                            , T11.T011_codigo   CodigoTpFone
                            , T11.T011_nome     NomeTpFone
                            , T10.T010_area     AreaFone
                            , T10.T010_numero   NroFone
...
//        echo $sql;
    ...
    public function verificaNumeros($login, $tpnro, $numero, $ramal)
    {
        $sql    =   " SELECT T10.T010_id
                        FROM T010_fone T10
                       WHERE T10.T004_login     = '$login'
                         AND T10.T011_codigo    = $tpnro
                         AND T10.T010_numero    = $numero
                          OR T10.T010_ramal     = $ramal";
    ...
    public function checaDepto($user){
        $sql    =   " SELECT T0677.T077_codigo  CodigoDepto
                        FROM T004_T006_T077 T0677
                       WHERE T0677.T004_login = '$user'";
    ...
    public function retornaParametro(){
        $sql    =   " SELECT T89.T089_valor ValorParametro
                        FROM T089_parametro_detalhe T89
                       WHERE T89.T003_codigo  = 8";
        
        return $this->query($sql)->fetchAll(PDO::FETCH_COLUMN);
        
    }
    
    public function retornaUltDataAlteracao($user){
        $sql    =   " SELECT T04.T004_data_ult_alteracao  DataUltAlteracao
                        FROM T004_usuario T04
                       WHERE T04.T004_login = '$user'";
