...
$(function(){
        ...
        ({
                ...
                buttons:
                {
                        Ok: function() 
                        {
                            ...
                            var historicoDiv    =   $("#dialogHistoricoDiversos").val() ;
                            ...
                            html    +=  "   <td class='vHistoricoDiv'>"+historicoDiv+"</td>";
        ...
        ({
                ...
                buttons:
                {
                        ...
                        {                            
                            ...
                            var tipo            =   $("#tipo").val()                ;
                            //InsereDados
                            $.get("?router=T0026/js.insereDados",{  tipo:tipo //Despesa com Km
                                                                   , cpf:vCpf
                                ...
                                if(dados!=0)
                                 {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function() {
                                                ...
                                                if (0 == document.activeAjaxConnections) {
                                                   ...
                                                   $(location).attr('href','?router=T0026/home&statusDespesa=2');
                                                }
                                     ...
                                     $.each($("#dDadosDiversos").find("tr"), function(){
                                         ...
                                         var vValor          =   $(this).find(".vValor").text() ;
                                         var vHistoricoDiv   =   $(this).find(".vHistoricoDiv").text();
    ...
    $("#botaoAlterar").click(function(){
        $("#dialog-modal").text("Tem certeza que deseja alterar a despesa!");
        $("#dialog-modal").dialog
        ({
                resizable: false,
                height:120,
                ...
                buttons:
                {
                        ...
                        {                            
                            ...
                            $.ajax({
                               url:"?router=T0026/js.excluir2" ,
                               type:'get',
                               data:{codigoDespesa:codigoDespesa,
                                     totalDespesa:totalDespesa,
                                     totalDespesaDiv:totalDespesaDiv,
                                     totalGeral:totalGeral                                     
                                 },
            ...
            buttons:{                
                'Upload':function(){
                    ...
                    $(".externalSite").contents().find('form').submit(function(){
                     ...
                     //  $.post("?router=T0026/js.tabArq",{codigoDespesa:codigoDespesa}, function(dados){
    ...
    $(".alterarLinha").live("click", function(){
...
function excluir(pagina, cod, path, tabela, campo, valor){
    $.get("?router=T0026/excluir", {pagina:pagina, cod:cod, path:path, tabela:tabela, campo:campo, valor:valor}, function(){
        $(".linhaArq_"+cod).remove(); 
    });
}
