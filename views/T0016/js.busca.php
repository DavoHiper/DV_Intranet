...
if ($tipo == 10)
{
    ...
    function CriaTabelaHTML($dados, $status)
    {
        ...
        {   
            ...
            $ValorBruto     = $objAp->formataMoeda($valores['ValorBruto']);
            ...
            $html[$i] .= "<td><table class='list-iten-arquivos'>";
                            ...
                            foreach($Arq  as  $campos=>$valores2)
                            {
                                 ...
                                 $link = "http://".$_SERVER[HTTP_HOST]."/intranet_41".CAMINHO_ARQUIVOS."CAT".$lnkArq.">".$valores2['NOM'];  
        
                                 $html[$i] .= "<td width='95%' ><a target='_blank' href=".$link."</a></td>";
