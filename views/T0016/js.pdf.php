...
$tit_cat = utf8_decode("CATEGORIA DA DESPESA");
...
$categoria         = utf8_decode(strtoupper($valores['NomeCategoria']));
...
$this->SetFont("arial","B",10);
$this->Cell(80,5,$tit_cat,"TLR",1,"L");

$this->SetFont("arial","",9);
$this->Cell(80,5,$categoria,"BLR",1,"L");
