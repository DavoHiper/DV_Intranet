                                        ...
                                        <td>
                                            ...
                                            <?php $Arq = $objUltimasAps->selecionaArquivos($valores['APCodigo']); foreach($Arq  as  $campos=>$valores2){
                                                ...
                                                <tr class="<?php echo $cor; ?>">
                                                    <td width="95%" ><a href="<?php echo "http://".$_SERVER[HTTP_HOST]."/intranet_41".CAMINHO_ARQUIVOS."CAT".$valores2['CAT']=$objUltimasAps->preencheZero("E", 4, $valores2['CAT'])."/".$arquivo=$objUltimasAps->preencheZero("E", 4, $valores2['ARQ']).".".$valores2['EXT']?>"><?php echo $valores2['NOM'];?></a></td>
