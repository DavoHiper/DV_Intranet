...
<div class="conteudo_16">
    ...
    <?php foreach($dadosDespesaKm as $cpDespKm => $vlDespKm){?>
        ...
        <div class="grid_1">
            <p><?php echo $vlDespKm['DespesaKm']."km";?></p>
        </div>

        <div class="grid_1">
            <p><?php echo $obj->formataMoeda($vlDespKm['DespesaKm']*$parametro);?></p>
            <?php $total    += $vlDespKm['DespesaKm']*$parametro;?>
        </div>
    ...
    <?php } ?>
        ...
        <div class="grid_2 push_13">
            <strong>Total:</strong>      
        </div>
        
        <div class="grid_2 push_12">
            <p><?php echo $obj->formataMoeda($total);?></p>      
        </div>
    ...
    <?php foreach($dadosDespesaDiv as $cpDespDiv => $vlDespDiv){ ?>
        ...
        <div class="grid_4">
            <p><?php echo $vlDespDiv['DespesaDescricao'];?></p>
        </div>

        <div class="grid_4">
            <p><?php echo $obj->formataMoeda($vlDespDiv['DespesaValor']);?></p>
            <?php  $totalDiv    +=  $vlDespDiv['DespesaValor'];?>
        </div>    
    ...
    <?php } ?>
        ...
        <div class="grid_2 push_13">
            <p><?php echo $obj->formataMoeda($totalDiv);?></p>
        </div>
