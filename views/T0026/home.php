...
switch ($statusDespesa) {
    ...
    case 6:
        ...
        break;
    case 7:
        $itensFiltrados =   $obj->retornaDespesasPagas($user,FiltroQuery(),$FiltroRegistros);
        break;
    case 8:
        $itensFiltrados =   $obj->retornaDespesasNaoPagas($user,FiltroQuery(),$FiltroRegistros);
        break;
}
?>
    ...
    <form action="?router=T0026/home/" method="get" class="div-filtro-visivel">
        ...
        <div class="grid_5">
            ...
            <select name="statusDespesa" id="statusDespesa">
                ...
                <option value="7" <?php echo $statusDespesa==7?"selected":""?>>Aprovadas e Pagas Tesouraria         </option>
                <option value="8" <?php echo $statusDespesa==8?"selected":""?>>Aprovadas e Não Pagas Tesouraria     </option>
            </select>
        </div>
...
<div class="conteudo_16">
    ...
    <table class="tablesorter tDados">
        ...
        <tbody>
        <?php   $i=0;  
                foreach($itensFiltrados as $campos=>$valores){ 
                $i++;
        ?>            
            <tr>
                ...
                <td width="10%">
                    ...
                    <table class='list-iten-arquivos'>   
                        ...
                        <?php foreach($ArquivosDespesa  as  $cpsArquivo =>  $vlsArquivo){
                            ...
                            ?>
                        <tr class='linhaArq_<?php echo $valores['DespesaCodigo'];?>'>
                ...
                <td>                                    
                    <ul class="lista-de-acoes">                          
                        ...
                        <?php } if($statusDespesa==1){?>
                            <li><a href="#" title="Aprovar"         class="aprovarDespesa"  ><span class='ui-icon ui-icon-check'>   </span></a></li>                                                            
                            <li><a href="#" title="Emitir Recibo"   class="emitirRecibo"  ><span class='ui-icon ui-icon-note'>   </span></a></li>                                                            
