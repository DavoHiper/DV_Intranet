...
$tab4                   = "T055_arquivos";      //Usa esssa variavel para definir se o arquivo é publico ou privado.
//Classe para ***
...
echo $_POST["T055_publico"];

if ($_POST["T055_publico"] != "") {
     
   $valores4 = array("T055_publico" => $_POST["T055_publico"]);
   
    $delim4 = "T055_codigo = ".$cod;
   
   $obj->Alterar($tab4, $valores4, $delim4);
