            ...
            <span  class="form-input">
                <table  class="form-inpu-tab">
                    <thead>
                        ...
                        <tr colspan="2">
                            <td colspan="2"><textarea name="T055_desc"  class="textarea-table" cols="" rows="" width="40"></textarea></td>
                        </tr>
                        <tr colspan="2">
                       ...
                       <tr colspan="2">
                        ...
                        <tr>
                            <td>
                            Restrito <input type="radio" value="0" name="T055_publico" checked/>
                            Público <input type="radio" value="1" name="T055_publico" />
                            </td>
                            <td><input type="text" value="" name="T055_tags"  size="100"/></td>
                        </tr>
                        <tr colspan="2">
                            <td colspan="2"><label class="label">Owner do Arquivo</label></td>
                        </tr>
                        <tr colspan="2">
                            <td colspan="2"><input type="text" value="<?php echo $owner ?>" name="T004_owner" class="buscaUsuario" size="100"/></td>
                        </tr>
                        <tr colspan="2">
