...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <!--<link href="template/css/temas/verde_limao/jquery.ui.all.css" rel="stylesheet" type="text/css" />-->
    ...
    <body>
        <div id="imagem-oferta" style="display:none;"></div> 
        <script>
            $(function(){  
                
                var nroImagem   =   1;
            
                function tempo(nroImagem){ 
                    
                    var parametro9   =   $.getJSON("?router=T0054/js.parametro",{parametro:9});
                    var parametro10   =   $.getJSON("?router=T0054/js.parametro",{parametro:10});                    
                    
                    $('#imagem-oferta').html('<img src="template/img/ImagemPainel_'+nroImagem+'.jpg">');                    
                    ...
                    setTimeout(function() {
                        ...
                        $("#logo-cabecalho").css('display','none');
                        $("#logo-cabecalho").css('display','none');
                        $("#cabecalho").css('display','none');
                        $("#conteudo").css('display','none');
                        $("#rodape").css('display','none');     

                        $("#imagem-oferta").css('display','block');

                        setTimeout(function() {

                            $("#imagem-oferta").css('display','none');

                            $("#logo-cabecalho").css('display','block');
                            $("#logo-cabecalho").css('display','block');
                    ...
                    <div class="tabela-conteudo">
                        ...
                        foreach($ListaProdutos as $campos=>$valores){ 
                           ...
                           { 
                             ...
                             {
                                 if(empty($valoresGrupo['DescricaoPainel']))
