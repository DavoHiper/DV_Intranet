...
// Verifica se o POST está vazio, caso não faz os inserts nas tabelas T077_departamento e T004_T006_T077
if (!empty($_POST))
{
    // Tebelas para inserir
    $tabela01 = "T077_departamento";
    $tabela02 = "T004_T006_T077";
    ...
    {    
        ...
        // Verifica se o segundo insert deu certo T004_T006_T077
        if ($insert02)
        {
