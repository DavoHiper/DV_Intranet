...
if($_POST["Busca"] != ""){
    ...
    $codAuditoria = $_POST["n_auditoria"];
    $lojaBusca = $_POST["T006_codigo_busca"];
    $departamentoBusca = $_POST["departamento_busca"];
    $dataInicial = $_POST["dataInicial"];
    $dataFinal = $_POST["dataFinal"];
    
$retornaArquivos    =   $obj->retornaArquivos("",$codAuditoria, $lojaBusca, $departamentoBusca, $dataInicial, $dataFinal);
}
?>
            ...
            <div class="coluna c04_tipo_d_01">       
                <label class="label">Departamento</label>
                    <select name="departamento" id="departamento">
                        ...
                        <?php foreach($obj->retornaDeptos() as $campos=>$valores){?>
     ...
     <form action="" method="post" class="div-filtro-visivel">
        ...
        <div class="conteudo-visivel padding-5px-vertical">
            <div class="coluna c01_tipo_d_01">       
                    ...
                    <select name="T006_codigo_busca" style="padding: 3px 0;" >
                        <option value="">Selecione...</option>
                        <?php
                            foreach($obj->retornaLojasSelectBox() as $campos=>$valores)
                            {
                        ?>
                            <option value="<?php echo $valores['Codigo']; ?>" <?php if ($codigoLoja == $valores['Codigo']) echo "selected";?>><?php echo $obj->preencheZero("E", 3, $valores['Codigo'])." - ".$valores['Nome']; ?></option>
                        <?php
        ...
        <div class="conteudo-visivel padding-5px-vertical">
            ...
            <div class="coluna c04_tipo_d_01">       
                <label class="label">Departamento</label>
                    <select name="departamento_busca" id="departamentoBusca">
                        <option value="">Selecione...</option>
            ...
            <div class="coluna c04_tipo_d_02">       
                ...
                <input type="text" name="dataInicial" id="dataInicial" class="data" size="8"/>
            </div>
            
            <div class="coluna c04_tipo_d_01">       
                <label class="label">Data Final</label>
                <input type="text" name="dataFinal" id="dataFinal" class="data" size="8"/>
            </div>

            <div class="coluna c04_tipo_d_03">       
                <label class="label">Número Auditoria</label>
                <input type="text" name="n_auditoria" id="n_auditoria"  size="8"/>
            </div>
        ...
        <div class="conteudo-visivel padding-5px-vertical">
            ...
            <div class="padding-5px-vertical margin-padrao-vertical coluna c02_tipo_b_01">
                ...
                <input type="submit" class="botao-padrao gerar" value="Buscar" id="Buscar">
            </div>
