                            ...
                            <tr>
                                <th align="center" colspan="2">
                                    <div class="div-primaria caixa-de-ferramentas padding-padrao-vertical">
                                        <ul class="lista-horizontal">
                                            <?php 
                                        //    echo $perfilUser."- ".$valores["Gerente"]." - ".$valores["CoordInventario"]. " - ".$a;
                                            ...
                                            <?php } elseif ((($perfilUser ==  55) &&($valores["Gerente"] == 1) && ($a > 0)) || (($perfilUser ==  56) &&($valores["CoordInventario"] == 1) && ($a > 0))) {  ?>
                                            ...
                                            <li><p style="background-color:  #CD5555;  position: absolute;">Ruptura Não Confirmada</p></li>
                                            <?php } elseif (($valores["Data"] <> date("d/m/Y")) && ($a == 0)&&(((($valores["Gerente"] == "")&&($perfilUser == 55))||(($valores["CoordInventario"] == "")&&($perfilUser == 56))))) {  ?>
                                            <li><a href="#"                     class="botao-padrao-verde rupturaItens"><span class="ui-icon ui-icon-newwin"  ></span>Ruptura</a></li><br><br>
                                            <li>Finalizar Ruptura</li>
