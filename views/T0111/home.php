...
if (!empty($_POST))
{
    ...
    if ($FiltroSetor != "0" && $FiltroSetor == '1')
        $filtros .= "AND TJ3.T004_login in ('colivei','amsilva', 'rsnascim', 'asoares', 'apedroso')";
           ...
           $valores["CPF"] = str_replace("-","",$valores["CPF"]);
                   ...
                   <tr class="linha_<?php echo $valores["Codigo"];?>">
                       ...
                       <td><ul>
                               ...
                               <?php if($_SESSION["user"] == "acfranca" || $_SESSION["user"] == "asoares" || $_SESSION["user"] == "nhigino" || $_SESSION["user"] == "rsnascim" || $_SESSION["user"] == "kscarpan" || $_SESSION["user"] == "psantos" || $_SESSION["user"] == "cmiranda" || ($_SESSION["user"] == $valores["Elaborador"] && $status == "1" || $status == "2" )) {?>
                                 <li>
                               <a class="ui-icon ui-icon-close" href="#"  onclick="excluirLinha(<?php echo $valores['Codigo']?>)"  title="Excluir"></a>
                               </li>
                               <?php }?>
                               <?php if($_SESSION["user"] == "acfranca" || $_SESSION["user"] == "asoares" || $_SESSION["user"] == "cmiranda" || $_SESSION["user"] == "nhigino" || $_SESSION["user"] == "rsnascim" || $_SESSION["user"] == "kscarpan" || $_SESSION["user"] == "psantos" ) {?>
                                   <li>
