    ...
    <div class="conteudo_16">
        ...
        <div class="clear10"></div>
            ...
            <div class="grid_7">
                ...
                <input type="text" name="T113_titulo"  id="titulo"   class="validate[required] form-input-text-table" value="<?php echo $vlrRM["TituloRM"]; ?>"    readonly   />            
            </div>
                 ...
                 if($statusRM >= 3){?>
                    ...
                    <?php if(($cmt   !=  0) && ($statusRM == 3)){
                        ...
                        <div style="position: absolute; top: 44px; left: 350px">
                                ...
                                <div id="radioC">
                                    <input type="radio" id="radio3" name="T113_aprovado" value="S" checked="checked"  class="validate[required]" /><label for="radio3">Sim</label>
                                    <input type="radio" id="radio4" name="T113_aprovado" value="N"  class="validate[required]" /><label for="radio4">Não</label>
                                </div>            
                            </div>
