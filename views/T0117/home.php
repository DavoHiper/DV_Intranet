...
if (!empty($_POST))    
{
    ...
    $status         =   $_POST['T113_status'];
        
    $dados          =   $obj->retornaRM($titulo, $descricao, $solicitante, $rm, $_SESSION["user"],$status);
}else
echo "";    
    ...
    <form action="" method="post">
        ...
        <div class="conteudo_16">
            ...
            <div class="grid_2">
                ...
                <select name="T113_status" id="statusRM">
                    <option value="">Selecione...</option>
                    <option value="3">Elaborada</option>
